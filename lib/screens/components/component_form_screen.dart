...
class ComponentFormScreen extends StatefulWidget {
  ...
  const ComponentFormScreen({super.key, required this.componentId});
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (widget.componentId != null) {
        context.read<ComponentProvider>().getById(widget.componentId!);
      }
    });
  }
        ...
        builder: (context, state, child) {
          ...
          if (widget.componentId != null) {
            if (state.component == null) {
              return const Center(child: Text('Componente não encontrado'));
            }

            _modelController.text = state.component!.model;
            _quantityController.text = state.component!.quantity.toString();
